...
int setup_mur ()
{
    ...
    if (partition_data[partition_x0].boundary_type == boundary_mur)
    {
        if (ey)
        {
            ey_x0    = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
            ey_x0_d  = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
            ey_x0_dd = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
        ...
        if (ez)
        {
            ez_x0    = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
            ez_x0_d  = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
            ez_x0_dd = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
        ...
        k1_x0   = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
        k2_x0   = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
        ky_x0   = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
        kz_x0   = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
    ...
    {
        k1_x1   = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
        k2_x1   = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
        ky_x1   = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
        kz_x1   = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
        ...
        if (ey)
        {
            ey_x1    = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
            ey_x1_d  = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
            ey_x1_dd = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
        ...
        if (ez)
        {
            ez_x1    = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
            ez_x1_d  = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
            ez_x1_dd = (double **)mem2(type_double, total_length_y + 1, total_length_z + 1);
    ...
    {
        k1_y0   = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
        k2_y0   = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
        kx_y0   = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
        kz_y0   = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
        ...
        if (ex)
        {
            ex_y0    = (double **)mem2(type_double, total_length_x, total_length_z + 1);
            ex_y0_d  = (double **)mem2(type_double, total_length_x, total_length_z + 1);
            ex_y0_dd = (double **)mem2(type_double, total_length_x, total_length_z + 1);
        ...
        if (ez)
        {
            ez_y0    = (double **)mem2(type_double, total_length_x, total_length_z + 1);
            ez_y0_d  = (double **)mem2(type_double, total_length_x, total_length_z + 1);
            ez_y0_dd = (double **)mem2(type_double, total_length_x, total_length_z + 1);
    ...
    {
        k1_y1   = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
        k2_y1   = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
        kx_y1   = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
        kz_y1   = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
        ...
        if (ex)
        {
            ex_y1    = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
            ex_y1_d  = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
            ex_y1_dd = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
        ...
        if (ez)
        {
            ez_y1    = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
            ez_y1_d  = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
            ez_y1_dd = (double **)mem2(type_double, total_length_x + 1, total_length_z + 1);
    ...
    {
        k1_z0   = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
        k2_z0   = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
        kx_z0   = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
        ky_z0   = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
        ...
        if (ex)
        {
            ex_z0    = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
            ex_z0_d  = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
            ex_z0_dd = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
        ...
        if (ey)
        {
            ey_z0    = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
            ey_z0_d  = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
            ey_z0_dd = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
    ...
    {
        k1_z1   = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
        k2_z1   = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
        kx_z1   = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
        ky_z1   = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
        ...
        if (ex)
        {
            ex_z1    = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
            ex_z1_d  = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
            ex_z1_dd = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
        ...
        if (ey)
        {
            ey_z1    = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
            ey_z1_d  = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
            ey_z1_dd = (double **)mem2(type_double, total_length_x + 1, total_length_y + 1);
        ...
        for (x = 0; x <= total_length_x; x++)
            for (y = 0; y <= total_length_y; y++)
            {
                c_dt = d_t / sqrt(epsilon[x][y][total_length_z - 1] * MU0);
...
static void update_ey_x0 ()
{
    ...
    for (y = 0; y < total_length_y; y++)
        for (z = 0; z < total_length_z; z++)
        {
            ...
            /*
            if (y > 0 && y < total_length_y && mode != mode_tmy && mode != mode_tey)
            {
            ...
            if (z > 0 && z < total_length_z && mode != mode_tmz && mode != mode_tez)
            {
...
static void update_ey_x1 ()
{
    ...
    for (y = 0; y < total_length_y; y++)
        for (z = 0; z < total_length_z; z++)
        {
            ...
            ey_x1_d[y][z] = ey[total_length_x][y][z];
...
static void update_ez_x1 ()
{
    ...
    for (y = 0; y < total_length_y; y++)
        for (z = 0; z < total_length_z; z++)
        {
            ...
            ez_x1_d[y][z]  = ez[total_length_x][y][z];
...
static void update_ex_y0 ()
{
    ...
    for (x = 0; x < total_length_x; x++)
        for (z = 0; z < total_length_z; z++)
        {
            ...
            /*
            if (x > 0 && x < total_length_x && mode != mode_tmx && mode != mode_tex)
            {
...
static void update_ex_y1 ()
{
    ...
    for (x = 0; x < total_length_x; x++)
        for (z = 0; z < total_length_z; z++)
        {
            ...
            ex_y1_d[x][z] = ex[x][total_length_y][z];
...
static void update_ez_y1 ()
{
    ...
    for (x = 0; x < total_length_x; x++)
        for (z = 0; z < total_length_z; z++)
        {
            ...
            ez_y1_d[x][z] = ez[x][total_length_y][z];
...
static void update_ey_z0 ()
{
    ...
    for (x = 0; x < total_length_x; x++)
        for (y = 0; y < total_length_y; y++)
        {
            //printf("(%d %d) k1: %e||%e k2:%e ey:%e||%e \n",x, y, k1_z0[x][y],k1_x0[x][y], k2_z0[x][y],k2_x0[0][0], ey[x][y][0]);
...
static void update_ex_z1 ()
{
    ...
    for (x = 0; x < total_length_x; x++)
        for (y = 0; y < total_length_y; y++)
        {
            ex[x][y][total_length_z] = ex_z1[x][y] - ex_z1_d[x][y] + k1_z1[x][y] * (ex[x][y][total_length_z - 1] + ex_z1_d[x][y]);

            ex_z1_dd[x][y] = ex_z1_d[x][y];
            ex_z1_d[x][y] = ex[x][y][total_length_z];

            ex_z1[x][y] = k2_z1[x][y] * (ex[x][y][total_length_z] + ex[x][y][total_length_z - 1]);
            /*
            if (x > 0 && x < total_length_x && mode != mode_tmx && mode != mode_tex)
            {
                ex_z1[x][y] += kx_z1[x][y] * (ex[x-1][y][total_length_z] - ex[x][y][total_length_z]);
                ex_z1[x][y] += kx_z1[x][y] * (ex[x-1][y][total_length_z - 1] - ex[x][y][total_length_z - 1]);
            }
            if (x > 0 && x < total_length_x && mode != mode_tmx && mode != mode_tex)
            {
                ex_z1[x][y] += kx_z1[x][y] * (ex[x+1][y][total_length_z] - ex[x][y][total_length_z]);
            ...
            if (y > 0 && y < total_length_y && mode != mode_tmy && mode != mode_tey)
            {
                ex_z1[x][y] += ky_z1[x][y] * (ex[x][y-1][total_length_z] - ex[x][y][total_length_z]);
                ex_z1[x][y] += ky_z1[x][y] * (ex[x][y-1][total_length_z - 1] - ex[x][y][total_length_z - 1]);
            }
            if (y > 0 && y < total_length_y && mode != mode_tmy && mode != mode_tey)
            {
                ex_z1[x][y] += ky_z1[x][y] * (ex[x][y+1][total_length_z] - ex[x][y][total_length_z]);
...
static void update_ey_z1 ()
{
    ...
    for (x = 0; x < total_length_x; x++)
        for (y = 0; y < total_length_y; y++)
        {
            ey[x][y][total_length_z] = ey_z1[x][y] - ey_z1_d[x][y] + k1_z1[x][y] * (ey[x][y][total_length_z - 1] + ey_z1_d[x][y]);

            ey_z1_dd[x][y] = ey_z1_d[x][y];
            ey_z1_d[x][y] = ey[x][y][total_length_z];

            ey_z1[x][y] = k2_z1[x][y] * (ey[x][y][total_length_z] + ey[x][y][total_length_z - 1]);
            /*
            if (x > 0 && x < total_length_x && mode != mode_tmx && mode != mode_tex)
            {
                ey_z1[x][y] += kx_z1[x][y] * (ey[x-1][y][total_length_z] - ey[x][y][total_length_z]);
                ey_z1[x][y] += kx_z1[x][y] * (ey[x-1][y][total_length_z - 1] - ey[x][y][total_length_z - 1]);
            }
            if (x > 0 && x < total_length_x && mode != mode_tmx && mode != mode_tex)
            {
                ey_z1[x][y] += kx_z1[x][y] * (ey[x+1][y][total_length_z] - ey[x][y][total_length_z]);
            ...
            if (y > 0 && y < total_length_y && mode != mode_tmy && mode != mode_tey)
            {
                ey_z1[x][y] += ky_z1[x][y] * (ey[x][y-1][total_length_z] - ey[x][y][total_length_z]);
                ey_z1[x][y] += ky_z1[x][y] * (ey[x][y-1][total_length_z - 1] - ey[x][y][total_length_z - 1]);
            }
            if (y > 0 && y < total_length_y && mode != mode_tmy && mode != mode_tey)
            {
                ey_z1[x][y] += ky_z1[x][y] * (ey[x][y+1][total_length_z] - ey[x][y][total_length_z]);
